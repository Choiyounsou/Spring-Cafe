	...
	<div class="page-flex">
		...
		<div class="main-wrapper">
			...
			<main class="main users chart-page" id="skip-target">
				<div class="container">
					...
					<div class="row">
						...
						<tr>
							...
							<td class="left-aligned-cell" colspan= "2"><%= bbs.getBbsTitle().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;").replaceAll(">", "&gt;").replaceAll("\n", "<br>") %></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="left-aligned-cell" colspan= "2"><%= bbs.getBbsDate().substring(0, 11) + bbs.getBbsDate().substring(11, 13) + " 시 " + bbs.getBbsDate().substring(14, 16) +" 분" %></td>
						</tr>
						<tr>
							<td class="centered-cell">내용</td>
							<td class="left-aligned-cell" colspan= "2" style="min-height: 200px; text-align: left;"><%= bbs.getBbsContent().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;").replaceAll(">", "&gt;").replaceAll("\n", "<br>") %></td>
						</tr>
					</tbody>
				</table>
				...
				%>
				<a href="update2.jsp?bbsID=<%= bbsID %>" class="input-submit">수정</a>
				<a onclick="return confirm('정말로 삭제하시겠습니까?');" href="deleteAction.jsp?bbsID=<%= bbsID %>" class="input-submit">삭제</a>
				<%
					}
				%>
						</div>
